...
var Carto_Dark = L.tileLayer('https://a.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}.png', {
    minZoom: 0,
    maxZoom: 20,
...
var Region = L.tileLayer.wms("http://localhost:8080/geoserver/UAM/wms", {
    layers: 'Region',
    format: 'image/png',
    transparent: true
}).addTo(map)
